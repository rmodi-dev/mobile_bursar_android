...
class ThemeConfig {
  static ThemeData createTheme({
    ...
    return ThemeData(
      ...
      // colorScheme: ColorScheme(surface: background, brightness: brightness, primary: null, onPrimary: null, secondary: null, onSecondary: null), colorScheme: ColorScheme(error: error),
    );
  }
